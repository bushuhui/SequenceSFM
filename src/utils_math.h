...
///
///  Note: please call 'rand_seed' first!
///
///  open  - ( or )
///  close - [ or ]
////////////////////////////////////////////////////////////////////////////////
...
void    random(std::vector<double> &r, int n, void *d=NULL);
void    randn(std::vector<double> &r, int n, double mean=0.0, double sd=1.0, void *d=NULL);

// Generate random permutation
void    randperm(int *r, int n, void *d=NULL);
void    randperm(std::vector<int> &r, int n, void *d=NULL);
