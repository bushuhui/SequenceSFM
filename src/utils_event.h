...
struct InputEvent
{
    ru32		type;			/* event type */
    ru32		source;			/* event source */

    ru64		timestamp;		/* timestamp of event */
    ru64		dt;             /* time elapsed after occured */
...
int input_event_qt_code_trans(ru32 cin, ru32 &cout);
